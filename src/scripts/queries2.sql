...
SELECT 
    AVG(p.Age) AS 'Average age of cats'
FROM Pet p
...
-- Owner's name, Pet's name, Vaccine name, Date it happened.
-- Sorted so that the most recent vaccinations are at the top.
SELECT 
