...
INSERT INTO Owner(Owner_ID, Description, Person_ID) VALUES (1, 'good boy', 2);
INSERT INTO Owner(Owner_ID, Description, Person_ID) VALUES (2, '', 3);
INSERT INTO Owner(Owner_ID, Description, Person_ID) VALUES (3, '', 5);
INSERT INTO Owner(Owner_ID, Description, Person_ID) VALUES (4, 'from the ArtsAcademy', 6);
...
INSERT INTO Employee(Employee_ID, Spec, Person_ID) VALUES (2, 'hairdresser', 4);
INSERT INTO Employee(Employee_ID, Spec, Person_ID) VALUES (3, 'student',7);
...
INSERT INTO Order1(Order_ID, Owner_ID, Service_ID, Pet_ID, Employee_ID, Time_Order, Is_Done, Mark, Comments) 
       VALUES (3, 1, 2, 3, 2, '2023-09-11 09:00', 1, 4, 'That cat is crazy!');
INSERT INTO Order1(Order_ID, Owner_ID, Service_ID, Pet_ID, Employee_ID, Time_Order, Is_Done, Mark, Comments) 
       VALUES (4, 1, 1, 1, 3, '2023-09-11 00:00', 1, 5, '');
INSERT INTO Order1(Order_ID, Owner_ID, Service_ID, Pet_ID, Employee_ID, Time_Order, Is_Done, Mark, Comments) 
       VALUES (5, 1, 1, 1, 3, '2023-09-16 11:00', 1, 3, 'Comming late');
INSERT INTO Order1(Order_ID, Owner_ID, Service_ID, Pet_ID, Employee_ID, Time_Order, Is_Done, Mark, Comments) 
